...
public class LogsController {
    ...
    public String chatbotLogs(@RequestParam Map<String, String> params,
        ...
        Page<ChatbotLogsEntity> logsPage = chatbotLogsService.readChatbotLogs(page, size, search);
        // 페이지네이션 데이터 생성
        PaginationDto<ChatbotLogsEntity> paginationDto = paginationService.createPaginationData(logsPage, page, 5);
